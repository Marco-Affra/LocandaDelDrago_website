...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { href: isHome ? '#recensioni' : '/#recensioni', label: t('RECENSIONI', 'REVIEWS') },
    { href: isHome ? '#contatti' : '/#contatti', label: t('CONTATTI', 'CONTACTS') },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
        ...
        <div className="flex-shrink-0">
          <Link to="/" className="block transition-transform hover:scale-105 active:scale-95">
            <img src="logo-locanda.png" alt="Locanda del Drago" className="h-20 md:h-24 w-auto drop-shadow-md" referrerPolicy="no-referrer" />
          </Link>
        </div>
