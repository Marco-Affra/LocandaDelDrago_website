...
export default function Events() {
  ...
  const banquetImages = [
    'https://picsum.photos/seed/banquet1/800/600',
    'https://picsum.photos/seed/banquet2/800/600',
    'https://picsum.photos/seed/banquet3/800/600',
    'https://picsum.photos/seed/banquet4/800/600'
  ];
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="relative py-20 bg-scuro text-white overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <img 
              src="https://picsum.photos/seed/events-bg/1920/1080" 
              alt="Background" 
