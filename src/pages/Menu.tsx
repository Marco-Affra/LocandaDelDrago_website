...
export default function Menu() {
  ...
  const openLightbox = (url: string, title: string) => {
    setSelectedImage({url: getImagePath(url), title });
  };
      ...
      <main className="flex-grow pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mb-12 bg-white p-6 md:p-8 rounded-xl border border-oro/30 shadow-lg"
          >
          ...
          <div className="flex flex-col lg:flex-row gap-8 relative">
            ...
            <div className="hidden lg:block w-1/4 shrink-0 sticky top-32 self-start max-h-[calc(100vh-10rem)] overflow-y-auto no-scrollbar rounded-xl">
              <div className="bg-white rounded-xl shadow-lg border border-oro/20 p-4">
