...
// Per cambiare il link e il percorso del file dell'evento in corso devo andare su 
// data/eventData.ts e cambiare il percorso del file ceh carico e la foto relativa all'evento
        ...
        >
          ...
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-4">
              <motion.a
                href={`${import.meta.env.BASE_URL}${currentEvent.detailsFile.replace(/^\//, '')}`}
                target="_blank"
