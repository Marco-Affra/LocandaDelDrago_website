  ...
  return (
    <section id="recensioni" className="py-24 bg-crema overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="flex justify-center items-center gap-6 mt-12">
            <button 
              ...
              className="p-2 text-bordeaux/50 hover:text-bordeaux transition-colors bg-white rounded-full shadow-sm hover:shadow-md"
        ...
        >
          <a 
            href="https://search.google.com/local/reviews?placeid=ChIJkSXlxk_uGRMR8CizJKruDyg"
            target="_blank"
            rel="noopener noreferrer"
